...
public class RentCarHelper {
    public static List<RentGeneralModel> detail(RentCarModel model){
        ...
        rentGeneralModel = new RentGeneralModel("Merk", model.getMerk_kendaraan(), R.drawable.ic_directions_car_black_24dp);
        detail.add(rentGeneralModel);

        rentGeneralModel = new RentGeneralModel("Plat Nomor", model.getPlat_nomor(), R.drawable.ic_format_list_numbered_black_24dp);
        detail.add(rentGeneralModel);

        rentGeneralModel = new RentGeneralModel("Tipe Kendaraan", model.getTipe_kendaraan(), R.drawable.ic_directions_car_black_24dp);
        detail.add(rentGeneralModel);
        ...
        rentGeneralModel = new RentGeneralModel("Tarif per hari", Functions.rupiahFormat(Float.valueOf(model.getTarif_kendaraan())), R.drawable.ic_monetization_on_black_24dp);
        detail.add(rentGeneralModel);
